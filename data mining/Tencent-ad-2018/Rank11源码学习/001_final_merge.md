...
将用户信息数据表\广告信息数据表\用户-广告点击历史记录数据表\2个测试集数据表进行合并.

将用户-广告点击历史记录数据表分成5等份part1~part5, 每一份中每条广告的点击率相等. part1用作验证集, part2~part5做训练集

将合并后的数据保存到一个表中, 但是给不同的数据打了不同的标签, 并记录了part2~part5的index.
...
- userFeature.csv
- train_test_merge.csv  [3个表的merge结果]
- aid_uid_test1.csv ![1533868894550](assets/1533868894550.png)

- aid_uid_test2.csv 

- train_part_y.csv![1533868942567](assets/1533868942567.png)
